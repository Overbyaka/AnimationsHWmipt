...
void imgui_render()
{
    ...
    for (Character& character : scene->characters)
    {
        ...
        if (ImGui::Begin("Animation settings"))
        {
            ...
            ImGui::Checkbox("Optimization", &character.optimization);
            ImGui::SliderFloat("Tolerance", &character.tolerance, 0.0f, 100.0f);
            ImGui::SliderFloat("Distance", &character.distance, 0.0f, 1000.0f);
